...
$(document).ready(function(){
	$("#btn-saveApplication").click(function(){
		//초안으로 지정 후에 저장....
		$("#setApplicationStatus").val("DRAFT");		 
		$("#applicationForm").submit();
		
	});
	
	$("#btn-submitApplication").click(function(){
		$("#setApplicationStatus").val("SUBMITTED");		 
		$("#applicationForm").submit();
	});
});
</script>
...
<form method="POST" action="${contextPath }/post/${article.getIdx()}/a/${application.getIdx()}/e" id='applicationForm'>
...
<div class="container" style="overflow: scroll; margin-bottom: 100px; z-index:0" id="mainContent">
	...
	<div class='row'>
		...
		<div class='col-md-4'>
		<a href="#" class='btn btn-default' id='btn-saveApplication'>보관함에 임시 저장</a>
		<br>
		<br>
		<a href="#" class='btn btn-primary' id='btn-submitApplication'>지원서 제출하기</a>
		</div>		
		<!-- right spacer -->
		<!-- <div class="col-md-2" id='spacer'></div> -->
		<!-- end of right spacer -->
...
<input type='hidden' name='setApplicationStatus' id='setApplicationStatus'/>
</form>
